...
#define AM62LX_DEV_TIMER1_CLKSEL_VD_CLOCKS 609
#define AM62LX_DEV_TIMER3_CLKSEL_VD_CLOCKS 621
#define AM62LX_DEV_WKUP_TIMER1_CLKSEL_VD_CLOCKS 633
...
__section(".const.devgroup.MAIN") = {
	...
	[AM62LX_PSC_LPSC_LPSC_MAIN_GP_USB0_ISO_N] = {
		...
		.flags = LPSC_MODULE_EXISTS|LPSC_DEPENDS|LPSC_NO_MODULE_RESET,
	},
...
static const struct dev_data
am62lx_dev_timer1_clksel_VD __attribute__((__section__(".const.devgroup.MAIN"))) = {
	.soc = {
		.psc_idx = PSC_DEV_NONE,
	},
...
static const struct dev_data
am62lx_dev_timer3_clksel_VD __attribute__((__section__(".const.devgroup.MAIN"))) = {
	.soc = {
		.psc_idx = PSC_DEV_NONE,
	},
...
static const struct dev_data
am62lx_dev_wkup_timer1_clksel_VD __attribute__((__section__(".const.devgroup.MAIN"))) = {
	.soc = {
		.psc_idx = PSC_DEV_NONE,
	},
...
static const struct dev_clk_data MAIN_dev_clk_data[642] __section(".const.devgroup.MAIN") = {
	...
	DEV_CLK_MUX(AM62LX_DEV_DMTIMER_DMC1MS_MAIN_0_CLOCKS,
		    ...
		    CLK_AM62LX_MAIN_TIMERCLKN_SEL_OUT0, 1, 11),
	...
	DEV_CLK_MUX(AM62LX_DEV_DMTIMER_DMC1MS_MAIN_2_CLOCKS,
		    ...
		    CLK_AM62LX_MAIN_TIMERCLKN_SEL_OUT2, 1, 11),
	...
	DEV_CLK_MUX(AM62LX_DEV_GPIO_144_WKUP_0_CLOCKS,
		    ...
		    CLK_AM62LX_WKUP_GPIO0_CLKSEL_OUT0, 1, 4),
	...
	DEV_CLK_MUX(AM62LX_DEV_WKUP_GTCCLK_SEL_DEV_VD_CLOCKS,
		    ...
		    CLK_AM62LX_WKUP_GTCCLK_SEL_OUT0, 1, 6),
	...
	DEV_CLK_MUX(AM62LX_DEV_WKUP_OBSCLK_MUX_SEL_DEV_VD_CLOCKS,
		    ...
		    CLK_AM62LX_WKUP_OBSCLK_MUX_SEL_OUT0, 1, 10),
	...
	DEV_CLK_MUX(AM62LX_DEV_WKUP_CLKOUT_SEL_DEV_VD_CLOCKS,
		    ...
		    CLK_AM62LX_WKUP_CLKOUT_SEL_OUT0, 1, 7),
	...
	DEV_CLK_MUX(AM62LX_DEV_OBSCLK0_MUX_SEL_DEV_VD_CLOCKS,
		    ...
		    CLK_AM62LX_MAIN_OBSCLK0_MUX_SEL_OUT0, 1, 11),
	...
	DEV_CLK_MUX(AM62LX_DEV_TIMER1_CLKSEL_VD_CLOCKS,
		    AM62LX_DEV_TIMER1_CLKSEL_VD_CLK,
		    CLK_AM62LX_MAIN_TIMERCLKN_SEL_OUT1, 1, 11),
	DEV_CLK_PARENT(AM62LX_DEV_TIMER1_CLKSEL_VD_CLOCKS,
	...
	DEV_CLK_PARENT(AM62LX_DEV_TIMER1_CLKSEL_VD_CLOCKS,
			...
			CLK_AM62LX_POSTDIV4_16FF_WKUP_0_HSDIVOUT7_CLK, 1, 9),
	DEV_CLK_MUX(AM62LX_DEV_TIMER3_CLKSEL_VD_CLOCKS,
		    AM62LX_DEV_TIMER3_CLKSEL_VD_CLK,
		    CLK_AM62LX_MAIN_TIMERCLKN_SEL_OUT3, 1, 11),
	DEV_CLK_PARENT(AM62LX_DEV_TIMER3_CLKSEL_VD_CLOCKS,
	...
	DEV_CLK_PARENT(AM62LX_DEV_TIMER3_CLKSEL_VD_CLOCKS,
			...
			CLK_AM62LX_POSTDIV4_16FF_WKUP_0_HSDIVOUT7_CLK, 1, 9),
	DEV_CLK_MUX(AM62LX_DEV_WKUP_TIMER1_CLKSEL_VD_CLOCKS,
		    AM62LX_DEV_WKUP_TIMER1_CLKSEL_VD_CLK,
		    CLK_AM62LX_WKUP_TIMERCLKN_SEL_OUT1, 1, 8),
	DEV_CLK_PARENT(AM62LX_DEV_WKUP_TIMER1_CLKSEL_VD_CLOCKS,
...
static struct dev_clk MAIN_dev_clk[642] __section(".bss.devgroup.MAIN");
...
const struct dev_data * const soc_device_data_arr[AM62LX_DEV_WKUP_TIMER1_CLKSEL_VD + 1U] = {
	...
	[AM62LX_DEV_TIMER1_CLKSEL_VD] = &am62lx_dev_timer1_clksel_VD,
	[AM62LX_DEV_TIMER3_CLKSEL_VD] = &am62lx_dev_timer3_clksel_VD,
	[AM62LX_DEV_WKUP_TIMER1_CLKSEL_VD] = &am62lx_dev_wkup_timer1_clksel_VD,
};

struct device soc_devices[AM62LX_DEV_WKUP_TIMER1_CLKSEL_VD + 1U];
